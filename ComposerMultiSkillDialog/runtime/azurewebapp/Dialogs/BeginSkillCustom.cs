...
namespace Microsoft.BotFramework.Composer.WebApp.Dialogs
{
    /// <summary>
    /// Begin a Skill.
    /// Need to take this class from the SDK because I can't pass in a custom activity
    /// to BeginDialogAsync & I can't modify the TurnContext activity
    /// I need to be able to pass in a custom activity to fix an issue with 2 skills being called simultaneously.
    /// </summary>
    public class BeginSkillCustom : SkillDialog
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BeginSkillCustom"/> class.
        /// </summary>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        [JsonConstructor]
        public BeginSkillCustom([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
